...
func TestIsValidIPv4(t *testing.T) {
	...
	*/
	...
	{
		i := net.IPNet{IP: net.IP{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xff, 0xff, 0x7f, 0x0, 0x0, 0x1}, Mask: net.IPMask{0xff, 0x0, 0x0, 0x0}}
		if !IsValidIPv4(i) {
			t.Fatalf("IsValidIPv4() failed with net.IPNet")
		}
	}
...
func TestIsValidIPv6(t *testing.T) {
	...
	*/
	{
		i := net.IPNet{IP: net.IP{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1}, Mask: net.IPMask{0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff}}
		if !IsValidIPv6(i) {
			t.Fatalf("IsValidIPv6() failed with net.IPNet")
		}
